...
# For custom target triples (JSON files), we need the file stem
cmake_path(GET _CORROSION_RUST_CARGO_TARGET_UNDERSCORE EXTENSION LAST_ONLY _target_file_ext)
string(TOUPPER _target_file_ext _target_file_ext_upper )
if ( EXISTS "${_CORROSION_RUST_CARGO_TARGET_UNDERSCORE}" AND "${_target_file_ext_upper}" STREQUAL "JSON" )
    cmake_path(GET _CORROSION_RUST_CARGO_TARGET_UNDERSCORE STEM LAST_ONLY _CORROSION_RUST_CARGO_TARGET_UNDERSCORE)
endif()
