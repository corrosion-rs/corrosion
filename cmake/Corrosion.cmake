...
function(_add_cargo_build out_cargo_build_out_dir)
    ...
    elseif(DEFINED ACB_KEYWORDS_MISSING_VALUES)
        # "lib" kind isn't guarenteed to produce byproducts so we can ignore missing value
        if ("lib" IN_LIST ACB_TARGET_KINDS AND "BYPRODUCTS" IN_LIST ACB_KEYWORDS_MISSING_VALUES)
            list(REMOVE_ITEM ACB_KEYWORDS_MISSING_VALUES "BYPRODUCTS")
        endif()

        list(LENGTH ACB_KEYWORDS_MISSING_VALUES ACB_KEYWORDS_MISSING_VALUES_LEN)
        if (${ACB_KEYWORDS_MISSING_VALUES_LEN} GREATER_EQUAL 1)
                message(FATAL_ERROR "Internal error - missing values for the following arguments: " ${ACB_KEYWORDS_MISSING_VALUES})
        endif()
    endif()
    ...
    elseif("staticlib" IN_LIST target_kinds OR "cdylib" IN_LIST target_kinds OR "lib" IN_LIST target_kinds)
